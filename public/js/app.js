...
application.load(Object(stimulus_webpack_helpers__WEBPACK_IMPORTED_MODULE_1__["definitionsFromContext"])(context)); //Axios
...
var map = {
	"./delete_controller.js": "./resources/js/controllers/delete_controller.js",
	"./dropdown_controller.js": "./resources/js/controllers/dropdown_controller.js",
...
/***/ "./resources/js/controllers/delete_controller.js":
/*!*******************************************************!*\
  !*** ./resources/js/controllers/delete_controller.js ***!
  \*******************************************************/
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function _continue() {
      ...
      console.log(id);
      axios["delete"]('/' + resource + '/' + id).then(function (response) {
        if (response.data == "ok") {
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function filter() {
      ...
      var display = (_this$data$get = this.data.get('display')) !== null && _this$data$get !== void 0 ? _this$data$get : 'initial';
...
__webpack_require__(/*! C:\Users\Bart Roos\Dropbox\WEB_WORKING\svs\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Bart Roos\Dropbox\WEB_WORKING\svs\resources\sass\app.scss */"./resources/sass/app.scss");
